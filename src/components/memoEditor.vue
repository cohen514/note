  ...
  <div>
    <div id="new-markdown" class="editor-layer">
      <div class="editor-top">
        <input class="editor-title form-control" type="text" placeholder="标题" v-model="newMarkdown.title">
    ...
    <div id="new-doodle" class="editor-layer">
      <div class="editor-top">
        <input class="editor-title form-control" type="text" placeholder="标题" v-model="newDoodle.title">
        <div class="dropdown select-category">
          <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
...
<script>
  ...
  export  default {
    ...
    methods:{
      ...
      closeDoodleEditor(){
        let canvasEle = $('#new-doodle .doodle-content')[0];
        this.newDoodle.contnet = canvasEle.toDataURL();
        this.hideAllEditorLayers();
      }
    }
  }
